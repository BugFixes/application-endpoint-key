...
const payLoadValid = {
  "resource": "/application/key",
  "path": "/v1/application/key",
  "httpMethod": "GET",
  "headers": {
...
describe('Application Key Endpoint', () => {
  it('should get key from id', (done) => {
    underTest(payLoadValid, console, (error, result) => {
      ...
      expect(resultObj).to.have.property('key')
      expect(resultObj.key).to.be.equal(process.env.TEST_APPLICATION_KEY)
